...
View.script = function (message) {
    ...
    Form.create(form, "settings", {
        "steamcmd": {
            ...
            "langParams": {"cmd": message.steamcmdDefault, "install": "sudo apt-get install steamcmd"}
        },
        "tar": {
            "type": "text",
            "placeholder": message.tarDefault ? "settings.default_placeholder" : null,
            "langParams": {"cmd": message.tarDefault, "install": "sudo apt-get install tar"}
        },
        "unzip": {
            "type": "text",
            "placeholder": message.unzipDefault ? "settings.default_placeholder" : null,
            "langParams": {"cmd": message.unzipDefault, "install": "sudo apt-get install unzip"}
        }
    }, function (formData) {
