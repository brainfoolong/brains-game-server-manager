...
lang.values.en = {
    ...
    "index.update-server.scheduled" : "The update is now in progress. This may take a while, the status information is available in the bgsm console. You will see a success message after the update is done.",
    "index.start-server.scheduled" : "Server start scheduled. You will see the status information in the bgsm console",
    "index.stop-server.scheduled" : "Server stop scheduled. You will see the status information in the bgsm console",
    ...
    "index.factorio.map.deletion-scheduled" : "Map will be deleted now. Maybe the server shutdown during this progress. You will see all status messages in the bgsm console",
    ...
    "index.backup.scheduled" : "Server backup is scheduled, watch the bgsm console for status information",
