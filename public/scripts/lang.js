...
lang.values.en = {
    ...
    "servers.game.rust.info": "All fields marked with {instant} apply the settings automatically to a running server. Fields with {restart} require a server restart to be applied. Fields with {caution} should be changed with caution after the server has been installed, it could break existing installation/map/serverdata.",
    "servers.game.factorio.info": "In factorio you can create different maps with a built in map generator. You can create and change the maps in the dashboard.",
    ...
    "servers.rust[branch].title": "Branch",
    "servers.rust[branch].sub": "Never change this after you've installed the server. It will break everything. Create a new server instance here to use another branch",
    "servers.rust[branch].value.public": "Public",
    "servers.rust[branch].value.prerelease": "Prerelease",
    "servers.rust[ip].title": "Server IP",
    "servers.rust[port].title": "Port",
    "servers.rust[port].sub": "Don't change it after some users have joined your server, they will loose the server from their server history",
    "servers.rust[rcon_ip].title": "RCON IP",
    "servers.rust[rcon_port].title": "RCON Port",
    "servers.rust[rcon_password].title": "RCON Password",
    "servers.rust[rcon_web].title": "RCON Web",
    "servers.rust[rcon_web].sub": "Way better RCON support, should be used if possible",
    "servers.rust[id].title": "Server identity",
    "servers.rust[id].sub": "Changed this will produce a complete new map with with all new settings",
    "servers.rust[maxplayers].title": "Max. players",
    "servers.rust[maxplayers].sub": "Max. players",
    "servers.rust[hostname].title": "Hostname",
    "servers.rust[hostname].sub": "The title in the serverbrowser",
    "servers.rust[description].title": "Description",
    "servers.rust[description].sub": "The description in the serverbrowser. Don't use \\n, you can use normal enter keystrokes for new lines",
    "servers.rust[headerimage].title": "Banner image URL",
    "servers.rust[headerimage].sub": "Exact 512x256 png or jpg",
    "servers.rust[url].title": "Homepage URL",
    "servers.rust[seed].title": "Map Seed",
    "servers.rust[worldsize].title": "Worldsize",
    "servers.rust[saveinterval].title": "Save interval",
    "servers.rust[globalchat].title": "Globalchat",
    "servers.rust[secure].title": "Secure mode",
    "servers.rust[stability].title": "Stability",
    "servers.rust[stability].sub": "If disabled than structures will never collapse",
    "servers.badge.instant": "Instant",
    "servers.badge.restart": "Restart",
    "servers.badge.caution": "Caution",
    "yes": "Yes",
    "no": "No",
    "save": "Save",
    "saved": "Saved",
    ...
    "index.backup.confirm": "Are you sure? This action usually require much CPU power for some minutes. If you do this until the server is running, which is possible, it can have bad side effects. Stop the server if possible, to be as stable as possible. The backup is only finished when you see a success message in the bgsm console. You may see the backup file before the progress is finished. Watch the console log carefully. Depending on the size of the server, it can take up to an hour to make the backup.",
    ...
    "index.factorio.missing.map": "No active map exist, you must create one with the map creator in the dashboard",
    "console.stopServer.1": "Stopping server",
    "console.stopServer.success.1": "Server stopped with messages: {msg}",
    "console.getLatestVersion.1": "Fetching latest available server version",
    "console.getLatestVersion.2": "Latest version is: {version}",
    "console.getLatestVersion.error.1": "Error getting latest version: {error",
    "console.getInstalledVersion.1": "Detect installed server version",
    ...
    "console.factorio.updateServer.success.1": "Update installed successfully",
    ...
    "index.pipeStdin.notrunning": "Server is not running",
    "index.pipeStdin.sent": "Command sent, see the logs for the results",
    ...
    "index.filebrowser.download": "Download file",
    "index.filebrowser.remove": "Remove file / folder",
    "index.filebrowser.createfile": "Create empty file",
    "index.filebrowser.createdir": "Create empty directory",
    "index.filebrowser.uploadfile": "Upload a file",
    "index.filebrowser.uploadarchive": "Upload archive (tar/zip) and unpack",
    "index.filebrowser.action": "Action",
    "index.filebrowser.create.placeholder": "Name your file/folder",
    "index.filebrowser.create.error": "File or folder already exist",
    "index.filebrowser.upload.placeholder": "Choose a file",
    "index.filebrowser.upload.progress": "Upload in progress, please wait until the filebrowser reloads",
    ...
    "console.rust.updateServer.1": "Update started, see steamcmd log for detailed information",
    "console.rust.updateServer.error.1": "Error while updating server: {error}",
    "console.rust.updateServer.success.1": "Update installed successfully",
    "logout.success": "Bye",
    "edit": "Edit",
    ...
    "loading": "Loading",
    "dashboard": "Dashboard",
    "socket.disconnect": "Connection to backend lost. Retrying in 5 seconds.",
